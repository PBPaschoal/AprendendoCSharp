 ...
 * Atualizado dia 21-08-2020 às 22:22hrs, Rio de Janeiro. 
 */
...
namespace ConsigConsultaProgram
{
    class ConsigConsulta03
    {
        static void Main(string[] args)
        {
            ...
            for(int i=0; i< repit; i++) //Nessa atualiação do dia 21/08/2020 apenas acrescentei a estrutura for para repetir quantas vezes
